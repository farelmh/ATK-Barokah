...
public class lap_laku extends javax.swing.JFrame {
...
//        CariData.TableSorter(tbl_untung, txt_cari, index, indexUang, null);
    ...
    public void tabelOperasional() {
        ...
        try {
            this.stat = k.getCon().prepareStatement("SELECT \n"
                    ...
                    + "    b.nama_barang,\n"
                    + "    k.nama_kategori,\n"
                    + "    COALESCE(SUM(dj.jumlah), 0) AS jumlah_terjual\n"
                    + "FROM barang b\n"
                    + "LEFT JOIN (\n"
                    + "    SELECT dj.id_barang, dj.jumlah\n"
                    + "    FROM detail_jual dj\n"
                    + "    JOIN penjualan p ON p.id_jual = dj.id_jual\n"
                    + ") dj ON b.id_barang = dj.id_barang\n"
    ...
    private void initComponents() {
        ...
        judul.setText("Daftar Barang Laku / Tidak Laku");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lap_laku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
