 ...
 * @author x260
 */
public class adm_transaksi_beli extends javax.swing.JFrame {
    ...
    private void btn_tambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tambahMouseClicked
        adm_tbh_transaksi_beli r = new adm_tbh_transaksi_beli();
        r.setVisible(true);
    ...
    private void karyawan2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_karyawan2MouseClicked
        adm_transaksi_jual r = new adm_transaksi_jual();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adm_transaksi_beli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adm_transaksi_beli().setVisible(true);
            }
        });
    }
