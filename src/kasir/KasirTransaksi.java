...
public class KasirTransaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_dataBarang1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_dataBarang1MouseClicked(evt);
            }
        });
    ...
    private void btn_tambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tambahMouseClicked
        KasirKeranjangTransaksi r = new KasirKeranjangTransaksi();
        r.setVisible(true);
        this.dispose();
    ...
    private void btn_dashboard1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_dashboard1MouseClicked
        KasirDashboard r = new KasirDashboard();
        if (keluar()) {
            r.setVisible(true);
            this.dispose();
        }
    ...
    private void btn_dataBarang1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_dataBarang1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_dataBarang1MouseClicked
