...
public class KasirKeranjangTransaksi extends javax.swing.JFrame {
    ...
    public KasirKeranjangTransaksi() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KasirKeranjangTransaksi().setVisible(true);
    ...
    private void tambahKerajang1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tambahKerajang1MouseClicked
        KasirTransaksi b = new KasirTransaksi();
        b.setVisible(true);
        this.dispose();
